    ...
    <div className="py-10 sm:py-14 md:py-[70px] feature">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-[34px] mb-8 md:mb-[50px]">
          {data.map((e,i) => (
            <div key={i} data-aos="fade-up" data-aos-duration={i * 200 + 800} className="grid sm:grid-cols-2 bg-white sm:gap-4 rounded-2xl sm:rounded-[40px] lg:rounded-3xl xl:rounded-[58px] overflow-hidden card cursor-pointer">
