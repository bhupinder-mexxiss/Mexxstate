...
const Header = () => {
  ...
  const Paths = ["/", "/find-broker", "/explore", "/insightshub", "/mortgage"];
    ...
    <>
      <header
        className={`w-full z-[999] header duration-300  ${
          isSticky
            ? "sticky_header"
            : "absolute  py-2 sm:py-4 lg:pt-9 lg:pb-8 top-0"
          ...
          >
            ...
            <div className="flex lg:pb-2">
              <Link to="/" className="-m-1.5 p-1.5">
                <img
                  className={`${isSticky ? "h-8" : "h-8 xl:h-10"} w-auto`}
                  src={
            ...
            <div className="flex items-center gap-3 lg:pb-2">
              <Link
                ...
                className="hidden w-8 md:w-10 h-8 md:h-10 rounded-full lg:flex items-center justify-center sm:border border-border1 hover:text-white hover:bg-primary hover:border-primary duration-300 saveBtn"
              >
