      ...
      <div className="container mx-auto ">
        <div className="md:grid grid-cols-2 relative">
          <div className="text-center md:text-start mb-6 xs:mb-10 md:mb-0">
            <h4 data-aos="fade-right" data-aos-duration="400"  className="text-[22px] sm:text-2xl lg:text-[32px] xl:text-[38px] xs:leading-9 lg:leading-[46px] xl:leading-[56px] font-medium text-white capitalize mb-5 xl:mb-7 max-w-[620px]">
              Looking to advertise a property? We can help.
            </h4>
            <button data-aos="fade-right" data-aos-duration="600" className="py-2.5 lg:py-4 px-6 xl:px-9 text-sm lg:text-base font-medium text-primary bg-white rounded-full">
              List Your Properties with us
            </button>
          </div>
          <div className="">
            <img data-aos="fade-left" data-aos-duration="800" data-aos-delay="300" 
              src={advertise}
              alt=""
