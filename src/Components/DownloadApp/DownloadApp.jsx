        ...
        <div className="md:grid grid-cols-2 ">
          <div className=" text-center sm:text-left">
            <h4
              ...
              className="capitalize font-medium text-white text-[22px] sm:text-2xl xl:text-[32px] mb-4 xl:mb-5 lg:leading-9 xl:leading-[48px] max-w-[310px] xs:max-w-[400px] md:max-w-full mx-auto sm:mx-0"
            >
            ...
            <p
              ...
              className="text-base text-white mb-3 lg:mb-9"
            >
            ...
            <div className="gap-7 hidden sm:flex">
              <div>
                <img
                  ...
                  src={appleStore}
                  alt=""
                  className="w-16 md:w-[78px] lg:w-[108px] mb-[14px]"
                />
                <div
                  data-aos="fade-up"
                  data-aos-duration="800"
                ...
                >
                  <img
                    src={bar_code}
                    alt=""
                    className="w-[56px] md:w-[70px] lg:w-[100px]"
                  />
                </div>
              </div>
              <div>
          ...
          <div className="">
            <img
              ...
              src={mobile2}
              alt=""
              className="absolute w-[440px] lg:w-[550px] xl:w-[670px] top-[-78px] xl:top-[-118px] right-0 hidden md:block"
            />
            <div className="w-[130px] sm:w-full h-[180px] sm:h-full overflow-hidden sm:overflow-visible mx-auto">
              <img
                src={mobile1}
                alt=""
                className="sm:absolute w-full  sm:w-36 right-8 top-0 block md:hidden"
              />
            </div>
